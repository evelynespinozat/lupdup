...
String nombreModulo	= "";
if(actionName.equals("centroSalud")) {
	nombreModulo	= "Centro Salud";
} else if(actionName.equals("entidadColaboradora")) {
	nombreModulo	= "Entidad Colaboradora";
} else if(actionName.equals("cuestionario")) {
	nombreModulo	= "Cuestionario";
} else if(actionName.equals("imagen")) {
	nombreModulo	= "Imagen";
} else if(actionName.equals("usuario")) {

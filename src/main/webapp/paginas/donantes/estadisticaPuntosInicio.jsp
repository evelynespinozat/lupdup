...
<div class="container-fluid" id="idDivPrincipalHistorialPuntos">
	<div class="row">
		...
		<div class="col-sm-12">
			<div class="row ">
				<div class="col-sm-12">
					<h4 class="semi-bold"><span class="semi-bold">Estadistica de puntos ganados</span><br>
					</h4>
				</div>
			</div>
		</div>
		...
		<div class="col-lg-12">
			...
			<div class="row">
				<div class="col-sm-12">
					...
					<input type="hidden" name="datosGrafica1a" value="<s:iterator value="%{#session.listHistorialPuntosGanados}" var="historial">['${historial.dteFecPuntoFecha}', ${historial.dblCntPuntoganadoPorciento}],</s:iterator>"/>
					<input type="hidden" name="datosGrafica1b" value="<s:iterator value="%{#session.listHistorialPuntosPerdidos}" var="historial">['${historial.dteFecPuntoFecha}', ${historial.dblCntPuntoperdidoPorciento}],</s:iterator>"/>
				</div>
			</div>

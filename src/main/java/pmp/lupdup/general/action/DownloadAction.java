...
public class DownloadAction extends ActionSupport {
	...
	public InputStream getArchivo() {
		...
		try {
			String strNomCodigo			= request.getParameter("strNomCodigo");
			if(CadenaUtil.getStrNull(strNomCodigo) != null) {
				String strRepositorioTemporal	= ConfiguracionProperties.getConstanteStr(ConfiguracionProperties.RUTA_BASE_REPOSITORIO);
				//String strNombreFileTemporal	= strNomCodigo;
				
				ImagenDto imagenDto			= new ImagenDto();
				imagenDto.setSrlIdImagen(CadenaUtil.getInte(strNomCodigo));
				Imagen imagen				= imagenService.buscarById(imagenDto);
				String strNombreFile	 = "";
				if(imagen != null) {
					strNombreFile		= imagen.getStrNomDescripcion();
					strNomCodigo		= imagen.getStrNomCodigo();
					File fileTemporal				= new File(strRepositorioTemporal, strNomCodigo);
			...
			} else if(strNomCodigo != null && strNomCodigo.equals("")) {

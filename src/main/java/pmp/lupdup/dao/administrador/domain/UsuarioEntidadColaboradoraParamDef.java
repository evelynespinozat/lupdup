...
public class UsuarioEntidadColaboradoraParamDef {
    ...
    public UsuarioEntidadColaboradoraParamDef() {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        public Criteria andIntIdEntidadcolaboradoraEqualTo(Integer value) {
            addCriterion("id_sedeentidadcolaboradora in (select sec.id_sedeentidad from lupdup.t_sede_entidad_colaboradora sec where sec.id_entidadcolaboradora = "+value+") ");
            return (Criteria) this;
        }
